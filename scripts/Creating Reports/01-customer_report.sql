...
Highlights:
	1. Gathers essential fields such as names, ages, and transactions
...
/*
----------------------------------------------------------------------------------
2) Customer Aggrigations: Summarize key metrics at the customer level
----------------------------------------------------------------------------------
*/
SELECT
	customer_key,
...
SELECT
	...
	-- Calculate average monthly spend (sales / lifespan)
	CASE 
